	...
	<div class="row">
		...
		<div class="col-sm-offset-1 col-sm-5 b-title" id="b-t-<?=$b_id?>">
			<div class="valign right">
				...
				<span>
					<a href="#<?=$b_id?>" rel="edit"><i class="fa fa-pencil-square-o"></i></a><a href="#<?=$b_id?>" rel="actions"><i class="fa fa-cog"></i></a>
				</span>
			</div> <!-- .valign -->
		</div>
		...
		<div class="col-sm-1 b-space">
		</div>

		<!-- // Backup edit -->
		<div class="col-sm-5 b-edit" id="b-e-<?=$b_id?>">
			<a href="#<?=$b_id?>-name" id="b-<?=$b_id?>-name-trigger" rel="section">
				<span class="l">Name</span> <span>My Docs</span>
			</a>
			<div class="b-section" id="b-<?=$b_id?>-name">
				<div class="">
			...
			<a href="#<?=$b_id?>-folders" id="b-<?=$b_id?>-folders-trigger" rel="section">
				<span class="l">Folders</span> <span>C:\...\Work\, C:\...\Finances\,</span>
			</a>
			<div class="b-section" id="b-<?=$b_id?>-folders">
				<div class="">
					<label for="i1">Destination</label>
					<select id="i2">
					  <option>S3 Compatible</option>
			...
			<a href="#<?=$b_id?>-destination" id="b-<?=$b_id?>-destination-trigger" rel="section">
				<span class="l">Destination</span> <span>S3 Bucket: backups</span>
			</a>
			<div class="b-section" id="b-<?=$b_id?>-destination">
				<div class="">
					<label for="i1">Destination</label>
					<select id="i2">
					  <option>S3 Compatible</option>
			...
			<a href="#<?=$b_id?>-schedule" id="b-<?=$b_id?>-schedule-trigger" rel="section">
				<span class="l">Schdule</span> <span>Daily at 1pm</span>
			</a>
			<div class="b-section" id="b-<?=$b_id?>-schedule">
				<div class="">
					<label for="i1">Destination</label>
					<select id="i2">
					  <option>S3 Compatible</option>
			...
			<a href="#<?=$b_id?>-options" id="b-<?=$b_id?>-options-trigger" rel="section">
				<span class="l">Options</span> <span>None specified</span>
			</a>
			<div class="b-section" id="b-<?=$b_id?>-options">
				<div class="">
					<label for="i1">Destination</label>
					<select id="i2">
					  <option>S3 Compatible</option>
		...
		<!-- // Backup operations -->
		<div class="col-sm-5 b-actions" id="b-a-<?=$b_id?>">			
				<a href="#">
